...
public class BaseBanner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private BaseBanner.BannerPagerAdapter adapter;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, com.youth.banner.R.drawable.gray_radius);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, com.youth.banner.R.drawable.white_radius);
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, com.youth.banner.R.drawable.no_banner);
        typedArray.recycle();
    }
    ...
    public BaseBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public BaseBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public BaseBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public BaseBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public BaseBanner setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public BaseBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public BaseBanner setPageTransformer(boolean reverseDrawingOrder, ViewPager.PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public BaseBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public BaseBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public BaseBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public BaseBanner setImages(List<?> imageUrls) {
    ...
    private void setData() {
        currentItem = 1;
        if (adapter == null) {
            adapter = new BaseBanner.BannerPagerAdapter();
...
//        Log.i(TAG,"currentItem: "+currentItem);
    ...
    @Deprecated
    public BaseBanner setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public BaseBanner setOnBannerListener(OnBannerListener listener) {
